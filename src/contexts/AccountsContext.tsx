...
interface AccountsContextType {
  ...
  createAccount: (account: Omit<Account, 'id' | 'user_id' | 'created_at' | 'updated_at'>) => Promise<{ data: Account | null; error: Error | null }>;
  updateAccount: (id: string, updates: Partial<Account>) => Promise<{ data: Account | null; error: Error | null }>;
  deleteAccount: (id: string) => Promise<{ error: Error | null }>;
  getTotalBalance: () => number;
  updateBalanceLocally: (accountId: string, amount: number) => void;
}
